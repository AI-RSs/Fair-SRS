...
class SessionGraph(Module):
    def __init__(self, n_node,hiddenSize,norm,TA,scale,batchSize,nonhybrid,step,lr,l2,lr_dc_step,lr_dc):
...
def train_test(model, train_data, test_data):
    ...
    #scores5_ind=[]
    scores5_i , scores5_val, scores10_i, scores10_val, scores20_i, scores20_val, scores500_i, scores500_val = [], [], [], [], [], [], [], []
    target_=[]
    for i in slices:
        ...
        scores500_val.append(trans_to_cpu(scores.topk(500)[0]).detach().numpy())
        ...
        sub_scores500 = trans_to_cpu(scores.topk(500)[1]).detach().numpy()
        scores5_i.append(sub_scores5)
        scores10_i.append(sub_scores10)
        scores20_i.append(sub_scores20)
        scores500_i.append(sub_scores500)
    ...
    scores500_value=[item for sublist in scores500_val for item in sublist]
    scores500_ind=[item for sublist in scores500_i for item in sublist]
    ...
    return hit5, mrr5, hit10, mrr10, hit20, mrr20, targets_, scores5_value, scores5_ind, scores10_value, scores10_ind, scores20_value, scores20_ind, scores500_value, scores500_ind